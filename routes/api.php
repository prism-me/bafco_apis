...
use App\Http\Controllers\ZohoCampaigns;
use App\Models\Cart;
...
// Route::post('zoho', [ZohoCampaigns::class, 'subscribe']);
...
Route::group(['prefix' => 'auth'], function ($router) {
    ...
    #Wishlist
    //for cms
    Route::get('wishlist_all', 'WishlistController@list')->middleware('auth:sanctum');
    //website
